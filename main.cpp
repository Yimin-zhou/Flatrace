...
//    SDL_Texture *framebuffer_texture = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STREAMING, m_width, m_height);
...
//        Tracer tracer;
//        #if 1
//            if (GlobalState::bboxView) tracer.renderFrame(camera, bvhBoundingBox, frame.pixels.get(), maxDepth);
//            tracer.renderFrame(camera, bvh, frame.pixels.get(), maxDepth);
////            tracer.renderFrameObb(camera, obbTree, frame.pixels.get(), maxDepth);
//        #else
//            renderFrame4X4(camera, bvh, frame.pixels.get());
//        #endif
//
//        const auto end = steady_clock::now();
////        std::cerr << fmt::format("Frame took {0} ms\n", duration_cast<milliseconds>(end - start).count());
//
//        // Compute stats
...
//        SDL_UpdateTexture(framebuffer_texture, nullptr, (void *) frame.pixels.get(), m_width*4);
//
